        ...
        <div className="container">
         <div className="row">
          <div className="col-md-6 mx-auto">
            ...
            <p>One challenge I faced was getting the model to provide a predictable output that I could concistently work with programmatically.  Rather than trying to get the model to return JSON, I decided to have it split up the data with pipes <code>|</code> and then split the string to create an array.  You can see my solution around <a href="https://github.com/mclausaudio/notion-personal-assistant-ai/blob/main/server/controllers/modelController.js#L24" target="_blank" rel="noopener noreferrer">this</a> line of code.</p>
            <p>This app is a simple React + ExpressJS app and is deployed to AWS EC3, s3 and API Gateway.</p>
